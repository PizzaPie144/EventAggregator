...
namespace PizzaPie.EventAggregator {
    public class EventAggregator : Singleton<EventAggregator>       //technically not needed to remain if on main menu or will need clean up
    {
        ...
        {
            private List<ISubscriber<T>> subs = new List<ISubscriber<T>>();
